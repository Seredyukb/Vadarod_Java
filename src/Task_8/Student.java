...
//        3.1 Из текста удалить все символы, кроме пробелов, не являющиеся буквами. Между последовательностями подряд идущих букв оставить хотя бы один пробел. (задача с использованием регулярных выражений)
    /*public String hello(String a, String b) {
        String result = "";
        if (a.endsWith(b)) {
            result = a.substring(a.length() - b.length(), a.length());
        } else {
    ...
    public static String chgStr(int k, String text) {
    ...
    public static String cleanText(String text) {
        String cleanedWord = text.replaceAll("[^a-zA-Zа-яА-ЯёЁ\\s]", "");
        cleanedWord = cleanedWord.replaceAll("\\s+", " ");
